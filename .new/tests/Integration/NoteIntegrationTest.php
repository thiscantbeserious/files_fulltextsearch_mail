...
namespace OCA\FilesFullTextSearchMail\Tests\Integration\Controller;

use OCP\AppFramework\App;
use OCP\IRequest;
use PHPUnit\Framework\TestCase;

use OCA\FilesFullTextSearchMail\Db\Note;
use OCA\FilesFullTextSearchMail\Db\NoteMapper;
use OCA\FilesFullTextSearchMail\Controller\NoteController;
...
class NoteIntegrationTest extends TestCase {
	...
	public function setUp(): void {
		$app = new App('filesfulltextsearchmail');
